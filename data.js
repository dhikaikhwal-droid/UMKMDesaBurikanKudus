const umkmData = {
    ...
    products: [
        ...
        { id: 2, category_id: 1, name: 'Topi Ecoprint', description: 'Topi dengan motif ecoprint yang stylish dan unik.', image: 'Topi Ecoprint.jpeg', whatsapp: '6287859221157' },
        ...
        // Category 2 - Jajan Sadis (Gambar dihilangkan untuk Baso Aci, Mie Lidi, dan Kerupuk Pedas)
        ...
        { id: 9, category_id: 2, name: 'Mie Lidi', description: 'Mie lidi dengan pilihan rasa pedas atau original.', image: null, whatsapp: '6285727745411' },
        ...
        // Category 8 - Susu Kedelai Bu Kati
        { id: 28, category_id: 8, name: 'Susu Kedelai Original', description: 'Susu kedelai murni tanpa pemanis buatan.', image: 'Susu Kedelai Original.png', whatsapp: '6285727297792' },
        { id: 29, category_id: 8, name: 'Susu Kedelai Strawberry', description: 'Susu kedelai dengan rasa strawberry yang segar.', image: 'Susu Kedelai Strawberry.png', whatsapp: '6285727297792' },
        { id: 30, category_id: 8, name: 'Susu Kedelai Chocolate', description: 'Susu kedelai dengan rasa coklat yang creamy.', image: 'Susu Kedelai Cokelat.png', whatsapp: '6285727297792' },
        
        // Category 9 - Rajut Bu Ratih
        { id: 31, category_id: 9, name: 'Tas Rajut', description: 'Tas rajut handmade Bu Ratih dengan desain unik.', image: 'tas rajut.png', whatsapp: '6285712345678' },
        { id: 32, category_id: 9, name: 'Topi Rajut', description: 'Topi rajut lembut dan hangat buatan Bu Ratih.', image: 'keychain rajut (1).png', whatsapp: '6285712345678' },
        { id: 33, category_id: 9, name: 'Dompet Rajut', description: 'Dompet rajut kecil yang lucu dan praktis.', image: 'Dompet Rajut.png', whatsapp: '6285712345678' },
        { id: 34, category_id: 9, name: 'Bunga Rajut', description: 'Bunga rajut hiasan yang tidak akan layu.', image: 'keychain rajut.png', whatsapp: '6285712345678' },

        // Category 10 - Snack Choiriyah
        { id: 35, category_id: 10, name: 'Roti Pisang', description: 'Roti pisang lembut dengan isian pisang asli yang manis dan gurih.', image: 'roti pisang.png', whatsapp: '6285876434103' },
        { id: 36, category_id: 10, name: 'Risoles', description: 'Risoles renyah dengan isian ragout ayam dan sayuran yang lezat.', image: 'risoles.png', whatsapp: '6285876434103' },
        { id: 37, category_id: 10, name: 'Kue Lapis', description: 'Kue lapis tradisional dengan lapisan warna-warni yang lembut dan manis.', image: 'kue lapis.png', whatsapp: '6285876434103' },
        { id: 38, category_id: 10, name: 'Donat Meses', description: 'Donat lembut dengan topping meses coklat yang manis dan menggoda.', image: 'donat meses.png', whatsapp: '6285876434103' },
        { id: 39, category_id: 10, name: 'Bolu Gulung', description: 'Bolu gulung dengan berbagai varian rasa yang lembut dan creamy.', image: 'bolu gulung.png', whatsapp: '6285876434103' }
    ]
};
